...
{
    return [[self alloc] initCannonWithName:name StartingPosition:point];
}
...
- (id) initCannonWithName: (NSString *)name StartingPosition: (CGPoint)point
{
	if ((self=[super init])) {
        ...
        self.body = [CCSprite spriteWithSpriteFrameName:[name stringByAppendingString:@"_cannon_body.png"]];
        self.mouth = [CCSprite spriteWithSpriteFrameName:[name stringByAppendingString:@"_cannon_mouth.png"]];
